  ...
  return (
    <section id={id} className="scroll-mt-[6.5rem] py-8 lg:py-10">
      <div className="border-t border-[var(--color-line-strong)] pt-4 lg:pt-[1.15rem]">
        ...
        <h2 className={`${sectionTitleClass} mt-5 max-w-4xl text-balance`}>{title}</h2>
        {text ? (
        ...
        >
          <div className="grid gap-4 lg:grid-cols-2">
            {sections.principles.map((item, index) => (
              <MotionReveal key={item} className="rounded-[1.45rem]">
        ...
        >
          <div className="space-y-5">
            {sections.featuredWork.map((project, index) => (
              <MotionReveal key={project.title} className="rounded-[1.45rem]">
                <article className={terminalPanelClass}>
            ...
            <div className={`${terminalPanelClass} overflow-hidden`}>
              <div className="grid gap-0 divide-y divide-[var(--color-line)]">
                {sections.skills.map((item) => (
                  ...
                  >
                    <p className={`${terminalLabelClass} pt-0.5`}>{item.group}</p>
                    <p className={`${terminalCopyClass} max-w-3xl text-pretty`}>
                      {item.list}
                    </p>
                  </div>
                ))}
