            ...
            <div className={`${panelClass} overflow-hidden`}>
              ...
              <div className="grid gap-6 p-5 sm:p-6 xl:grid-cols-[minmax(0,1fr)_17rem]">
                <div className="min-w-0 space-y-5">
                  ...
                  <h1 className="max-w-4xl text-balance [font-family:var(--font-display),sans-serif] text-[clamp(1.8rem,5.5vw,4.2rem)] font-semibold leading-[0.88] tracking-[-0.075em]">
