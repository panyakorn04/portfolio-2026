...
const titleClass = `${fontDisplayClass} text-[clamp(2rem,4vw,3.8rem)] font-semibold leading-[1.02] tracking-[-0.04em] text-balance`;
const bodyClass =
      ...
      <div className="mx-auto max-w-6xl space-y-6">
        <section className={panelClass}>
          ...
          <div className="mt-6 max-w-4xl space-y-4 border-b border-[var(--color-line)] pb-6">
            <p className={formLabel}>{copy.eyebrow}</p>
          ...
          {featuredArticle ? (
            <article className="mt-6 grid gap-8 border-b border-[var(--color-line)] py-8 lg:grid-cols-[minmax(0,1.25fr)_14rem]">
              <div>
                <p className={formLabel}>{copy.featuredLabel}</p>
              ...
              <div className="border-l border-[var(--color-line)] p-4">
                <dl className="space-y-4">
                  ...
                  <div>
                    <dt className={formLabel}>Type</dt>
        ...
        {restArticles.length ? (
          <section className={panelClass}>
            <div className="flex items-center justify-between gap-3">
              <p className={formLabel}>{copy.listLabel}</p>
