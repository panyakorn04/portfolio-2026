...
const bodyClass =
    "text-[0.96rem] leading-[1.9] text-[var(--color-muted)] sm:text-[1rem]";
const labelClass =
            ...
            <div className="mx-auto max-w-4xl">
                <article className={panelClass}>
                    ...
                    <header className="mt-6 border-b border-[var(--color-line)] pb-6">
                        ...
                        <h1 className={`${titleClass} mt-5`}>
                            {article.title}
                        </h1>
                        <p
                            className={`${bodyClass} mt-4 max-w-3xl text-pretty`}
                        >
                            {article.summary}
                        </p>
                    ...
                    <div className="mt-6 space-y-6">
                        <p className={`${bodyClass} text-pretty`}>
                            {article.lead}
                        </p>
                            ...
                            >
                                ...
                                <div className="mt-3 space-y-4">
                                    {section.paragraphs.map((paragraph) => (
                                        <p
                                            key={paragraph}
                                            className={`${bodyClass} text-pretty`}
                                        >
                                            {paragraph}
                                        </p>
                                    ))}
