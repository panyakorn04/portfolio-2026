...
import type { ArticleListItem } from "@/lib/articles-api";
...
export type PortfolioArticleSummary = ArticleListItem;

async function ArticlesList({
  articlesPromise,
  locale,
  articleCopy,
  linkButtonSecondaryClass,
}: {
  articlesPromise: Promise<PortfolioArticleSummary[]>;
  locale: Locale;
  articleCopy: PortfolioDictionary["articleDirectory"];
  linkButtonSecondaryClass: string;
}) {
  ...
  return (
    ...
    >
      ...
      <Link
        ...
        className={`${linkButtonSecondaryClass} mt-8`}
      >
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-[88rem] px-5 sm:px-8 lg:px-12">
        ...
        <Suspense
          fallback={
            <div className="animate-pulse space-y-5 border-t border-[var(--color-line)] py-8">
              <div className="h-3 w-24 rounded bg-[var(--color-panel)]" />
              <div className="h-10 w-3/4 rounded bg-[var(--color-panel)]" />
              <div className="h-4 w-full rounded bg-[var(--color-panel)]" />
            </div>
          }
        >
          <ArticlesList
            ...
            linkButtonSecondaryClass={linkButtonSecondary}
          />
        </Suspense>
          ...
          <div className="grid gap-12 lg:grid-cols-[minmax(0,1fr)_20rem]">
            ...
            <div className="border-t border-[var(--color-line)]">
              {contacts.map((c) => (
                ...
                >
                  <span className={eyebrow}>{contactLabels[c.key]}</span>
        ...
        <footer className="flex flex-col justify-between gap-5 border-t border-[var(--color-line)] py-10 sm:flex-row">
          <p className={eyebrow}>
            {footer.copyright.replace("{year}", String(new Date().getFullYear()))} · v
            {appVersion}
          </p>
