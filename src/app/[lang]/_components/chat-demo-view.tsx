...
export default function ChatDemoView({
    ...
    const activeStageLabel = agentLoopState.trace.findLast(
        ...
        <div className={widgetShellClass}>
            ...
            {show ? (
                <section
                    ...
                    className={`${flyoutClass} relative`}
                >
                    <div className="flex items-center justify-between gap-3 border-b border-[var(--color-line)] px-4 py-3">
                        <div className="flex items-center gap-2.5">
                            ...
                            <div className="flex items-center gap-1.5">
                                ...
                                <span className="text-[0.55rem] text-[var(--color-soft)]">
                                    /
                                </span>
                                <button
                                    type="button"
                                ...
                                <>
                                    ...
                                    {isWaiting ? (
                                        <div className="flex justify-start">
                                            <div className="flex items-center gap-2.5 rounded-2xl rounded-tl-sm border border-[var(--color-line)] bg-[rgba(10,20,16,0.8)] px-3.5 py-3">
                                                <div
                                                ...
                                                {activeStageLabel ? (
                                                    <p className="font-mono text-[0.66rem] uppercase tracking-[0.05em] text-[var(--color-soft)]">
                                                        {activeStageLabel}
                                                    </p>
                                                ) : null}
                                            </div>
